...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener {
            ...
            //addObject(Uri.parse("Calculator.sfb"))
            //addObject(Uri.parse("Desk lamp.sfb"))
//            addObject(Uri.parse("ComputerLaptop_1285.sfb"))
//            addObject(Uri.parse("Heart.sfb"))
//            addObject(Uri.parse("orchid.sfb"))

            addObject(Uri.parse("mode_1l.sfb"))
            //addObject(Uri.parse("model_1.sfb"))
            //addObject(Uri.parse("mode_l.sfb"))
            //addObject(Uri.parse("Paper_518.sfb"))
            //addObject(Uri.parse("render-v4.sfb"))
